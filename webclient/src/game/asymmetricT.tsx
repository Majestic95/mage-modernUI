...
function OpponentLane({
  ...
  if (collapsed) {
    return (
      <button
        ...
        data-collapsed="true"
        onClick={onFocus}
        className="rounded border border-zinc-800/60 bg-zinc-900/40 flex items-center gap-3 px-3 hover:bg-zinc-900/70 transition-colors text-left"
      >
  ...
  return (
    <div
      ...
      className="rounded-md border border-zinc-800/60 bg-zinc-900/30 flex min-h-0 min-w-0 overflow-hidden"
    >
      <div
